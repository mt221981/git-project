...
### 2. E-E-A-T (Expertise, Authoritativeness, Trustworthiness):
- שימוש במינוח משפטי מקצועי
- 6-8 ציטוטים חוקיים - סעיפי חוק מדויקים עם מספרים
- קישורים חיצוניים: nevo.co.il, gov.il
- Disclaimer בסוף המאמר

### 2.5 הנחיות לציטוטים (חשוב!):
**מספרי הליך ושמות פסקי דין:**
- ✓ מותר להזכיר עקרונות כלליים: "על פי הפסיקה", "ההלכה הפסוקה קובעת"
- ✓ מותר להזכיר חוקים בשמם: "חוק הנזיקין האזרחיים", "חוק הביטוח הלאומי"
- ✗ אל תצטט מספרי הליך ספציפיים: לא "ע"א 123/45", לא "ת"א 456/20"
- ✗ אל תצטט שמות פסקי דין: לא "פלוני נ' אלמוני"
- אם פסק הדין שלפניך מזכיר תקדים - הזכר את העיקרון, לא את מספר התיק

**דוגמה:**
❌ רע: "בע"א 1234/20 פלוני נ' חברת החשמל נקבע..."
✅ טוב: "בפסיקה נקבע שמעביד חייב באחריות קפידה..."

### 3. SEO:
- מילת מפתח ראשית: צפיפות 1.2-1.5%
- מילות מפתח משניות: 3-5 הזכרות כל אחת
- Meta title (60 תווים)
- Meta description (150-160 תווים)
- קישורים פנימיים: 3-5
- קישורים חיצוניים: 2-3

### 4. קריאות:
- משפטים קצרים (ממוצע 15 מילים)
- פסקאות קצרות (2-3 שורות)
- רשימות תבליטים (5-6 לפחות)
- מילות מעבר טבעיות
